...
<html>
  ...
  <body>
  <?php 
      include "$_SERVER[DOCUMENT_ROOT]/obiektowo/read_user_logic.php";
...
<div class="conteiner">
    ...
    <div id="uzytkownicy">
        ...
        <label style="color:red;">Rodzaj karnetu:  </label> <label style="font-weight: bold;"><?php echo $results['nazwa_karnetu'];?></label> <br>
        <label style="color:red;">Data ważności:   </label> <label style="font-weight: bold;"><?php echo $results['data_waznosci'];?></label> <br>
